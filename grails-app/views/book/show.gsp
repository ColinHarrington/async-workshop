	...
	<body>
		...
		<div id="show-book" class="content scaffold-show" role="main">
			...
			<ol class="property-list book">
				...
				<g:if test="${bookInstance?.qty}">
				<li class="fieldcontain">
					<span id="qty-label" class="property-label"><g:message code="book.qty.label" default="Qty" /></span>
					
						<span class="property-value" aria-labelledby="qty-label"><g:fieldValue bean="${bookInstance}" field="qty"/></span>
			...
			<g:form>
				<fieldset class="buttons">
					...
					<g:link class="addToCart" controller="cart" action="add" id="${bookInstance?.id}">Add to Cart</g:link>
				</fieldset>
			</g:form>
		</div>
	</body>
